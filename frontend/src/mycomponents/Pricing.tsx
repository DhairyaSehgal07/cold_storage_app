  ...
  return (
    <>
      <section className="section-pricing py-[9.6rem]" id="pricing">
        ...
        {isMobile ? (
          <>
            <div className="container mx-auto mb-[4.8rem] grid max-w-[120rem] items-center gap-y-[9.6rem] px-[3.2rem]">
              <div className="w-[100%] justify-center rounded-[11px] border-2 border-solid border-[#fdf2e9] p-[4.6rem]">
                <header className="plan-header mb-[4.8rem] text-center">
                  ...
                  <p className="plan-price mb-[1.6rem] text-[6.2rem] font-semibold text-foreground">
                    <span className="mr-[0.8rem] text-[3rem] font-medium">
                      $
                    </span>
                    399
                  </p>
                ...
                <ul className="list flex list-none flex-col gap-[1.6rem]">
                  <li className="flex   items-center gap-[1.6rem] text-[1.8rem] leading-[1.2]">
                    {/* <ion-icon
              ...
              <div className="w-[100%] justify-center rounded-[11px] border-2 border-solid border-[#fdf2e9] p-[4.6rem]">
                ...
                <ul className="list  flex list-none flex-col gap-[1.6rem]">
                  <li className="leading-1.2 flex  items-center gap-[1.6rem] text-[1.8rem]">
                    {/* <ion-icon
                  className="w-[3rem] h-[3rem] text-[#e67e22]"
                  name="checkmark-outline"
                ></ion-icon> */}
            ...
            <div className="gapy-y-[9.6rem] container       mx-auto mb-[4.8rem]  grid  max-w-[120rem] items-center gap-x-[6.4rem]  px-[3.2rem]">
            ...
            <div className=" gapy-y-[9.6rem]   mx-auto  grid max-w-[120rem] grid-cols-1 items-center gap-x-[6.4rem]  px-[3.2rem]">
              <div className="feature">
                {/* <ion-icon
              className="text-[#e67e22] h-[3.2rem] w-[3.2rem] bg-[#fdf2e9] mb-[3.2rem] p-[1.6rem] rounded-full"
              name="infinite-outline"
            ></ion-icon> */}
                <p className=" mb-[1.6rem] text-[2.4rem] font-bold text-foreground">
                  Purity Pact
                </p>
                <p className="feature-text mb-[2.4rem] text-[1.8rem] leading-[1.8]">
                  The crop cold-storage app, a steadfast commitment to crop
                  freshness, minimizing waste, and ensuring unparalleled
                  quality.
                </p>
              </div>
              <div className="feature">
            ...
            ></ion-icon> */}
                ...
                <p className="feature-text mb-[2.4rem] text-[1.8rem] leading-[1.8]">
                  Optimal temperature control in the app helps extend the shelf
                  life of stored crops, reducing economic losses.
                </p>
              </div>
              <div className="feature">
                ...
                <p className="feature-text mb-[2.4rem] text-[1.8rem] leading-[1.8]">
                  ...
                  deterioration, contributing to reduced economic loss for
                  farmers.
                </p>
              </div>
              <div className="feature">
                ...
                <p className="feature-text mb-[2.4rem] text-[1.8rem] leading-[1.8]">
                  The app facilitates smart inventory management, aiding farmers
                  in tracking, planning, and optimizing supply chain logistics.
                </p>
              </div>
            </div>
          </>
          ...
          <>
            ...
            <div className="grid--4-cols gapy-y-[9.6rem] container        mx-auto mb-[4.8rem] grid max-w-[120rem] grid-cols-4 items-center gap-x-[6.4rem]  px-[3.2rem]">
              <div className="feature">
                {/* <ion-icon
              className="text-[#e67e22] h-[3.2rem] w-[3.2rem] bg-[#fdf2e9] mb-[3.2rem] p-[1.6rem] rounded-full"
              name="infinite-outline"
