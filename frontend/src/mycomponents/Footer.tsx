const Footer = () => {
  ...
  return (
    <>
      <footer
        id="footer"
        className="footer border-t border-solid border-gray-300 py-[12.8rem]"
      >
        {isMobile ? (
          <>
            <div
              className="mx-auto grid max-w-[120rem]  gap-x-[3.2rem] gap-y-[9.6rem]  px-[3.2rem]   "
              style={{
...
"
          ...
          <>
            <div
              className="mx-auto grid max-w-[120rem]  gap-x-[6.4rem] gap-y-[9.6rem]  px-[3.2rem]  md:grid-cols-5 "
              style={{
                gridTemplateColumns:
